#!/usr/bin/env python3
"""
NexusController - Test delayed tab creation
Theory: Crash happens when creating tabs too quickly in sequence
"""
...
class NexusDelayedTabs:
    def __init__(self):
        print("Starting NexusController with delayed tab creation...")
        
        self.root = tk.Tk()
        self.root.title("NexusController - Delayed Tabs Test")
    ...
    def create_basic_ui(self):
        ...
        title = tk.Label(header, text="🌐 NexusController - Delayed Tabs", 
    ...
    def on_closing(self):
        """Handle shutdown"""
        print("Shutting down delayed tabs test...")
    ...
    def run(self):
        ...
        try:
            print("Starting delayed tabs main loop...")
            self.root.mainloop()
            print("Delayed tabs test ended.")
            
        except Exception as e:
            print(f"Error in delayed tabs test: {e}")

if __name__ == '__main__':
    print("Testing NexusController with delayed tab creation...")
    print("Theory: Crash caused by creating complex tabs too quickly")
    
    try:
        app = NexusDelayedTabs()
        app.run()
    except Exception as e:
        print(f"Fatal error in delayed tabs test: {e}")
        import traceback
        traceback.print_exc()
    
    print("Delayed tabs test complete.")