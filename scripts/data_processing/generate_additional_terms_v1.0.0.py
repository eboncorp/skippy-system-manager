#!/usr/bin/env python3
"""
Generate additional glossary terms from campaign materials
Based on all the policy documents, budget info, and campaign strategy read
"""

import json

# Additional terms based on campaign materials reviewed
additional_terms = [
    # MINI SUBSTATIONS & PUBLIC SAFETY
    {
        ...
        "louisville_context": "Dave's plan calls for 46 mini substations across Louisville Metro, one for each ZIP code area, at a total cost of $29.9 million over 4 years. Each substation costs approximately $650,000 annually to operate (officer salaries, facility lease, equipment). Evidence from Chicago shows mini substations reduce crime by 35% in served areas and improve police-community relations by 40%.",
        ...
        "dave_proposal": "Deploy 46 mini substations over 4 years: Year 1 (12 substations in highest-crime areas), Year 2 (12 more), Year 3 (12 more), Year 4 (10 final substations). Each staffed with 6 officers providing 24/7 coverage. Total annual operating cost: $29.9M from reallocated public safety budget."
    },
    {
        "term": "Response Time",
...
def main():
    output_file = '/home/dave/skippy/claude/downloads/extracted/additional_terms_from_campaign_data.json'

    print(f"📝 Generating {len(additional_terms)} additional glossary terms...")
    print()
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        json.dump(additional_terms, f, indent=2, ensure_ascii=False)

    print(f"✅ Created: {output_file}")
    print(f"   Total new terms: {len(additional_terms)}")
    print()
    print("🔄 Next step: Merge these with existing glossary to create complete collection")
