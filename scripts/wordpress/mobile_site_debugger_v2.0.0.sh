...
# Mobile Site Debugger v2.0.0
# Comprehensive mobile responsiveness testing tool
# Created: November 9, 2025
# v2.0.0: Fixed path detection, added auto-detection for Local by Flywheel
...
# WordPress Path Detection Function (shared with comprehensive debugger)
...
echo -e "${BLUE}═══════════════════════════════════════════════════════════${NC}"
echo -e "${BLUE}   Mobile Site Debugger v2.0.0${NC}"
echo -e "${BLUE}═══════════════════════════════════════════════════════════${NC}"
echo ""
...
**Status:** $(grep -q "viewport" "$SITE_PATH/wp-content/themes/astra/header.php" 2>/dev/null && echo "✅ Viewport meta tag present" || echo "⚠️ Viewport meta tag missing")
...
**Status:** $(grep -q "clamp" "$SITE_PATH/wp-content/themes/astra-child/style.css" 2>/dev/null && echo "✅ Modern fluid typography (clamp) used" || echo "⚠️ Fixed font sizes may not scale smoothly")
...
**Debug Report Generated By:** Mobile Site Debugger v2.0.0
**Date:** $(date)
...
- ✅ Enhanced: Auto-detects WordPress installation
- ✅ Improved: Better error messages and installation hints
