...
# 4. Make changes
sed 's/OLD_VALUE/$1.2 billion/g' "$SESSION_DIR/page_105_before.html" > "$SESSION_DIR/page_105_final.html"

# 5. Fact-check (creates record - Hook #3 enables this)
/fact-check "Updated budget to $1.2 billion per QUICK_FACTS_SHEET"
